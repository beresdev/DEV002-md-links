...
```sh
$ md-links-beresdev ./some/example.md
...
```sh
$ md-links-beresdev ./some/example.md --validate
...
```sh
$ md-links-beresdev ./some/example.md --stats
Total: 3
Unique: 3
```
...
```sh
$ md-links-beresdev ./some/example.md --stats --validate
Total: 3
Unique: 3
Broken: 1
```
